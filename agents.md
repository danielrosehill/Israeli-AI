...
| [JLM Shelter Agent](https://github.com/danielrosehill/JLM-Shelter-Agent) | AI-powered Android chatbot that finds the nearest public shelter (miklat) in Jerusalem, with GPS lookup and Maps navigation | ![](https://img.shields.io/github/stars/danielrosehill/JLM-Shelter-Agent?style=social) |
